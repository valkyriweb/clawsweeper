...
function prBody(context: LooseRecord) {
  ...
  return [
    ...
    "",
    "Guardrails: re-check the finding against latest `main` before changing code; keep the patch to the narrowest behavior change and matching regression coverage; do not merge automatically.",
    "",
    "## Source",
    "",
    ...sourceLines,
